...
# The exporters take the certificate file and the session as keyword
# arguments, and apply them to the requests they send themselves, so all that
# is left to test here is that AppSignal hands them over.
