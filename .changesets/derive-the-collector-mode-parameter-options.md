...
Setting one of the new options still overrides the value that would be derived for it. The `appsignal diagnose` report shows the values AppSignal worked out under a new `derived` configuration source.
